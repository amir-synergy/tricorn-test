...
const CrimePreventionThroughEnvironmentalDesignConsiderations = ({
    ...
    const { register, errors, handleSubmit, onSubmit, setData, data, removeFromData } = useFormHandler({
        assessmentId,
        currentStep,
        saveData,
        setFormSubmit,
            ...
            <div className='my-5'>
                <div className='mb-5'>
                    <p className='text-lg font-medium'>
                        8.1 Crime Prevention Through Environmental Design Considerations
                    </p>
                </div>
                    ...
                    return (
                        <div key={index} className='mb-5 p-4 border rounded-lg relative'>
                            <div className='mb-5'>
                                ...
                                />
                                {errors.itemName && (
                                    <span className='text-red-500'>{errors.itemName.message?.toString()}</span>
                                )}
                            </div>
...
export default CrimePreventionThroughEnvironmentalDesignConsiderations;